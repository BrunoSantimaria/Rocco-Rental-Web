const Imagen = "https://res.cloudinary.com/di92lsbym/image/upload/v1731080807/IMG_3053_kmc0lf.jpg";
export const Title = () => {
  return (
      ...
      <div className='absolute  mx-0 align-middle my-20 ml-5'>
        <section className='lg:my-20 '>
          <h1 className='absolute w-80 text-color3 tracking-xl text-4xl whitespace-pre-line font-josefin font-semibold ml-2 mt-16'>
            Estamos para <span className='text-color2'>{`${"ayudarte"}\n`} </span> a hacer el trabajo.{"\n"}{" "}
            <div className='pt-10'>
              <span className='text-color2'>Rocco Rental</span> {"\n"}Alquiler de plataformas y andamios.
            </div>
          </h1>
        </section>
      </div>
